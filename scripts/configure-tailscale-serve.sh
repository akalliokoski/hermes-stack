...
"${TAILSCALE_CMD[@]}" serve --bg --https=9446 http://127.0.0.1:3000
...
expected = {f"{domain}:443", f"{domain}:9443", f"{domain}:9444", f"{domain}:9445", f"{domain}:9446", f"{domain}:13378", f"{domain}:8096"}
